...
def continued_deflation_old(eps_0, eps_f, delta_eps,  sol_eps, mesh_eps, guess, grid, uni_grid, monitor_func, boor_tol, physical_tol, N, alpha, power, u_0, u_n, guess_list, damping):
  ...
  while eps >= eps_f:
    ...
    for i in range(len(results)):
      ...
      print('For eps = ', eps, 'we found', results[i][1], 'solutions')
      print()
...
def continued_deflation(eps_0, eps_f, delta_eps,  sol_eps, mesh_eps, guess, grid, uni_grid, monitor_func, boor_tol, physical_tol, N, alpha, power, u_0, u_n, guess_list, damping):
